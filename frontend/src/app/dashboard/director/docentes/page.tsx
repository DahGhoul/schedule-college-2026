...
import { UserPlus, Search, Mail, Phone, Briefcase, GraduationCap, Calendar } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <Modal 
        ...
        titulo={docenteSeleccionado ? "Editar Información del Docente" : "Registrar Nuevo Docente"}
      >
        <form onSubmit={manejarSubmit} className="space-y-6">
          ...
          {!docenteSeleccionado && (
            <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <label htmlFor="crear_usuario" className="text-sm font-medium text-slate-700 cursor-pointer">
                Crear automáticamente cuenta de usuario para este docente
              </label>
            </div>
          )}
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-slate-100">
            ...
            <Boton type="submit" cargando={mutationCrear.isPending || mutationEditar.isPending} className="rounded-xl px-8 shadow-md shadow-unt-primary/10">
              {docenteSeleccionado ? 'Guardar Cambios' : 'Registrar Docente'}
            </Boton>
          </div>
        </form>
      </Modal>
